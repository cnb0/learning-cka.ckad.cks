...
| kube-controller-manager| `Component that runs controller processesnode. Controllers include : Node Controller, ReplicaSet Controller, Endpoints Controller, Service Account & Token Controllers`| `Static Pod` |
